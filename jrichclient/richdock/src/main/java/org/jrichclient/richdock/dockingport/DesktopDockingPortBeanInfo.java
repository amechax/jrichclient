...
public class DesktopDockingPortBeanInfo extends SimpleBeanInfo {
// PropertyDescriptors *********************************************************
	
	@Override
	public PropertyDescriptor[] getPropertyDescriptors() {
		List<PropertyDescriptor> descriptorList = new ArrayList<PropertyDescriptor>();
		addDockingPortPropertyDescriptors(descriptorList, DesktopDockingPort.class);
		
		descriptorList.add(createPropertyDescriptor(DesktopDockingPort.class,
			"exitOnDispose", "getExitOnDispose", "setExitOnDispose", 
...
// PersistenceDelegate *********************************************************
	...
	private static final PersistenceDelegate DELEGATE = new Delegate();
	...
	private static class Delegate extends DefaultPersistenceDelegate {
		...
		protected void initialize(Class<?> type, Object oldInstance, 
			...
			DesktopDockingPort port = (DesktopDockingPort)oldInstance;
...
// BeanDescriptor **************************************************************
	...
	public BeanDescriptor getBeanDescriptor() {
		BeanDescriptor descriptor = new BeanDescriptor(DesktopDockingPort.class);
