...
public class MultiSplitDockingPortBeanInfo extends SimpleBeanInfo {
// PropertyDescriptors *********************************************************
	
	@Override
	public PropertyDescriptor[] getPropertyDescriptors() {
		List<PropertyDescriptor> descriptorList = new ArrayList<PropertyDescriptor>();
		addDockingPortPropertyDescriptors(descriptorList, MultiSplitDockingPort.class);
		
		descriptorList.add(createPropertyDescriptor(MultiSplitDockingPort.class,
...
// BeanDescriptor **************************************************************
	...
	public BeanDescriptor getBeanDescriptor() {
		BeanDescriptor descriptor = new BeanDescriptor(MultiSplitDockingPort.class);
