...
// Test Constructor ************************************************************
	...
	public void testCornerIcon() {
		...
		dockable.addPropertyChangeListener(
			StatusBarDockable.PROPERTYNAME_CORNER_ICON, listener);
		
		propertyChange(listener, new PropertyChangeEvent(dockable, 
			StatusBarDockable.PROPERTYNAME_CORNER_ICON, oldCornerIcon, newCornerIcon));
		propertyChange(listener, new PropertyChangeEvent(dockable, 
			StatusBarDockable.PROPERTYNAME_CORNER_ICON, newCornerIcon, oldCornerIcon));
		...
		dockable.removePropertyChangeListener(
			StatusBarDockable.PROPERTYNAME_CORNER_ICON, listener);
		verify(listener);
	}
