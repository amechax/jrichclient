/*
 * $Id: JXMultiSplitPane.java,v 1.3 2007/05/31 23:54:27 hansmuller Exp $
 *
...
import org.jrichclient.richdock.multisplitpane.MultiSplitLayout.Divider;
...
public class JXMultiSplitPane extends JPanel {
    ...
    public static abstract class DividerPainter {
    	public abstract void paint(Graphics2D g, Divider divider, int width, int height);
    }

    private class DefaultDividerPainter extends DividerPainter {
        public void paint(Graphics2D g, Divider divider, int width, int height) {
