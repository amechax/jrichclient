...
public class ViewDockingPortBeanInfo extends SimpleBeanInfo {
// PropertyDescriptors *********************************************************
	
	@Override
	public PropertyDescriptor[] getPropertyDescriptors() {
		List<PropertyDescriptor> descriptorList = new ArrayList<PropertyDescriptor>();
		addDockingPortPropertyDescriptors(descriptorList, ViewDockingPort.class);
		
		descriptorList.add(createPropertyDescriptor(ViewDockingPort.class,
			"toolBar", "getToolBar", "setToolBar",
...
// BeanDescriptor **************************************************************
	...
	public BeanDescriptor getBeanDescriptor() {
		BeanDescriptor descriptor = new BeanDescriptor(ViewDockingPort.class);
