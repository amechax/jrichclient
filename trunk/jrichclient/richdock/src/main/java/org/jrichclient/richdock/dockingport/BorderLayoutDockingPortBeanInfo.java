...
public class BorderLayoutDockingPortBeanInfo extends SimpleBeanInfo {
// PropertyDescriptors *********************************************************
	
	@Override
	public PropertyDescriptor[] getPropertyDescriptors() {
		List<PropertyDescriptor> descriptorList = new ArrayList<PropertyDescriptor>();
		addDockingPortPropertyDescriptors(descriptorList, BorderLayoutDockingPort.class);
		
		descriptorList.add(createPropertyDescriptor(BorderLayoutDockingPort.class,
			"hgap", "getHgap", "setHgap", 
			BOUND, NOT_CONSTRAINED, NOT_TRANSIENT));
		
		descriptorList.add(createPropertyDescriptor(BorderLayoutDockingPort.class,
			"vgap", "getVgap", "setVgap", 
			BOUND, NOT_CONSTRAINED, NOT_TRANSIENT));
...
// BeanDescriptor **************************************************************
	...
	public BeanDescriptor getBeanDescriptor() {
		BeanDescriptor descriptor = new BeanDescriptor(BorderLayoutDockingPort.class);
