...
public class ScrollPaneDockingPortBeanInfo extends SimpleBeanInfo {
// PropertyDescriptors *********************************************************
	
	@Override
	public PropertyDescriptor[] getPropertyDescriptors() {
		List<PropertyDescriptor> descriptorList = new ArrayList<PropertyDescriptor>();
		addDockingPortPropertyDescriptors(descriptorList, ScrollPaneDockingPort.class);
		
		descriptorList.add(createPropertyDescriptor(ScrollPaneDockingPort.class,
			"horizontalScrollBarPolicy", "getHorizontalScrollBarPolicy", "setHorizontalScrollBarPolicy",
			BOUND, NOT_CONSTRAINED, NOT_TRANSIENT));
		
		descriptorList.add(createPropertyDescriptor(ScrollPaneDockingPort.class,
			"verticalScrollBarPolicy", "getVerticalScrollBarPolicy", "setVerticalScrollBarPolicy",
			BOUND, NOT_CONSTRAINED, NOT_TRANSIENT));
...
// BeanDescriptor **************************************************************
	...
	public BeanDescriptor getBeanDescriptor() {
		BeanDescriptor descriptor = new BeanDescriptor(ScrollPaneDockingPort.class);
