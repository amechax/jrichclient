...
public class SplitPaneDockingPortBeanInfo extends SimpleBeanInfo {
// PropertyDescriptors *********************************************************
	
	@Override
	public PropertyDescriptor[] getPropertyDescriptors() {
		List<PropertyDescriptor> descriptorList = new ArrayList<PropertyDescriptor>();
		addDockingPortPropertyDescriptors(descriptorList, SplitPaneDockingPort.class);
		
		descriptorList.add(createPropertyDescriptor(SplitPaneDockingPort.class,
			"orientation", "getOrientation", "setOrientation",
			BOUND, NOT_CONSTRAINED, NOT_TRANSIENT));
		
		descriptorList.add(createPropertyDescriptor(SplitPaneDockingPort.class,
			"continuousLayout", "isContinuousLayout", "setContinuousLayout",
			BOUND, NOT_CONSTRAINED, NOT_TRANSIENT));
...
// BeanDescriptor **************************************************************
	...
	public BeanDescriptor getBeanDescriptor() {
		BeanDescriptor descriptor = new BeanDescriptor(SplitPaneDockingPort.class);
