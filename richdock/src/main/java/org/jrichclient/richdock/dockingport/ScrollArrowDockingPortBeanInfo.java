...
public class ScrollArrowDockingPortBeanInfo extends SimpleBeanInfo {
// PropertyDescriptors *********************************************************
	
	@Override
	public PropertyDescriptor[] getPropertyDescriptors() {
		List<PropertyDescriptor> descriptorList = new ArrayList<PropertyDescriptor>();
		addDockingPortPropertyDescriptors(descriptorList, ScrollArrowDockingPort.class);
		
		descriptorList.add(createPropertyDescriptor(ScrollArrowDockingPort.class,
			"horizontalArrowPolicy", "getArrowPolicy", "setHorizontalArrowPolicy",
			BOUND, NOT_CONSTRAINED, NOT_TRANSIENT));
		
		descriptorList.add(createPropertyDescriptor(ScrollArrowDockingPort.class,
			"verticalArrowPolicy", "getVerticalArrowPolicy", "setVerticalArrowPolicy",
			BOUND, NOT_CONSTRAINED, NOT_TRANSIENT));
...
// BeanDescriptor **************************************************************
	...
	public BeanDescriptor getBeanDescriptor() {
		BeanDescriptor descriptor = new BeanDescriptor(ScrollArrowDockingPort.class);
